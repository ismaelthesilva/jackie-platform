          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mb-8 animate-fade-in">
              {selectedRegion === "brazil" ? (
                <Badge
                  variant="secondary"
                  className="text-emerald-100 bg-emerald-500/20 border-emerald-400/30 px-6 py-2 text-sm backdrop-blur-sm shadow-lg"
                >
            ...
            <div
              className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 animate-slide-in-up"
              ...
              {selectedRegion === "brazil" ? (
                <>
                  <Button
                    asChild
                    size="lg"
                    className="bg-emerald-600 hover:bg-emerald-700 dark:bg-black dark:hover:bg-gray-900 text-white shadow-2xl transform hover:scale-105 transition-all duration-300"
                  >
                    <Link
                      href="/contact"
                  ...
                  <Button
                    asChild
                    size="lg"
                    className="bg-transparent hover:bg-white/10 text-white border-2 border-white shadow-2xl transform hover:scale-105 transition-all duration-300"
                  >
                    <Link
                      href="/review"
                      className="flex items-center gap-2 px-8 py-4"
            ...
            <div
              className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto mb-12 animate-slide-in-up"
            ...
            >
              <div className="text-center">
                ...
                <div className="text-3xl font-bold text-emerald-400">
                  {selectedRegion === "brazil"
                    ? t("home.stats.brazil.clients.number")
                    : t("home.stats.newzealand.clients.number")}
                </div>
                <div className="text-sm text-gray-300">
                  {selectedRegion === "brazil"
                    ? t("home.stats.brazil.clients.label")
                    : t("home.stats.newzealand.clients.label")}
                </div>
              </div>
              <div className="text-center">
                <div className="flex items-center justify-center mb-2">
                ...
                <div className="text-sm text-gray-300">
                  {selectedRegion === "brazil"
                    ? t("home.stats.brazil.countries.label")
                    : t("home.stats.newzealand.countries.label")}
                </div>
              </div>
              <div className="text-center">
                <div className="flex items-center justify-center mb-2">
                ...
                <div className="text-3xl font-bold text-purple-400">
                  {t("home.stats.experience.number")}
                </div>
                <div className="text-sm text-gray-300">
                  {selectedRegion === "brazil"
                    ? t("home.stats.brazil.experience.label")
                    : t("home.stats.newzealand.experience.label")}
                </div>
              </div>
              <div className="text-center">
                <div className="flex items-center justify-center mb-2">
                ...
                <div className="text-sm text-gray-300">
                  {selectedRegion === "brazil"
                    ? t("home.stats.brazil.success.label")
                    : t("home.stats.newzealand.success.label")}
                </div>
              </div>
            </div>
          ...
          {selectedRegion === "brazil" ? (
            ...
            <div className="max-w-5xl mx-auto text-center space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-8 mt-12">
                <div className="bg-red-100 dark:bg-red-900/30 p-8 rounded-lg">
                  <h3 className="font-bold text-red-800 dark:text-red-300 mb-6 text-xl">
                    ❌ {t("home.problem.brazil.problem.title")}
                  </h3>
                ...
                <div className="bg-green-100 dark:bg-green-900/30 p-8 rounded-lg">
                  <h3 className="font-bold text-green-800 dark:text-green-300 mb-6 text-xl">
                    ✅ {t("home.problem.brazil.solution.title")}
                  </h3>
            ...
            <div className="max-w-5xl mx-auto text-center space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-8 mt-12">
                <div className="bg-red-100 dark:bg-red-900/30 p-8 rounded-lg">
                  <h3 className="font-bold text-red-800 dark:text-red-300 mb-6 text-xl">
                    ❌ {t("home.problem.newzealand.problem.title")}
                  </h3>
                  <ul className="text-left space-y-3 text-red-700 dark:text-red-400">
                ...
                <div className="bg-green-100 dark:bg-green-900/30 p-8 rounded-lg">
                  <h3 className="font-bold text-green-800 dark:text-green-300 mb-6 text-xl">
                    ✅ {t("home.problem.newzealand.solution.title")}
                  </h3>
                  <ul className="text-left space-y-3 text-green-700 dark:text-green-400">
                ...
                <CardHeader className="p-8">
                  ...
                  <div className="mt-auto">
                    <div className="text-3xl font-bold text-green-600">
                      {t("home.services.brazil.service1.price")}
                    </div>
                    <div className="text-sm text-muted-foreground">
                      {t("home.services.brazil.service1.period")}
                    </div>
                  </div>
                </CardHeader>
              </Card>
                ...
                <CardHeader className="p-8">
                  ...
                  <div className="mt-auto">
                    <div className="text-3xl font-bold text-emerald-600">
                      {t("home.services.brazil.service2.price")}
                    </div>
                    <div className="text-sm text-muted-foreground">
                      {t("home.services.brazil.service2.period")}
                    </div>
                  </div>
                </CardHeader>
              </Card>
                ...
                <CardHeader className="p-8">
                  ...
                  <div className="mt-auto">
                    <div className="text-3xl font-bold text-teal-600">
                      {t("home.services.brazil.service3.price")}
                    </div>
                    <div className="text-sm text-muted-foreground">
                      {t("home.services.brazil.service3.period")}
                    </div>
                  </div>
                </CardHeader>
              </Card>
            ...
            <div className="grid gap-8 lg:grid-cols-3 max-w-6xl mx-auto">
              <Card className="border-0 shadow-lg bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-950 dark:to-emerald-900">
                <CardHeader className="p-8">
                  ...
                  <div className="mt-auto">
                    <div className="text-3xl font-bold text-green-600">
                      {t("home.services.newzealand.service1.price")}
                    </div>
                    <div className="text-sm text-muted-foreground">
                      {t("home.services.newzealand.service1.period")}
                    </div>
                  </div>
                </CardHeader>
              </Card>
              ...
              <Card className="border-0 shadow-lg bg-gradient-to-br from-emerald-50 to-green-100 dark:from-emerald-950 dark:to-green-900">
                <CardHeader className="p-8">
                  ...
                  <div className="mt-auto">
                    <div className="text-3xl font-bold text-emerald-600">
                      {t("home.services.newzealand.service2.price")}
                    </div>
                    <div className="text-sm text-muted-foreground">
                      {t("home.services.newzealand.service2.period")}
                    </div>
                  </div>
                </CardHeader>
              </Card>
              ...
              <Card className="border-0 shadow-lg bg-gradient-to-br from-teal-50 to-green-100 dark:from-teal-950 dark:to-green-900">
                <CardHeader className="p-8">
                  ...
                  <div className="mt-auto">
                    <div className="text-3xl font-bold text-teal-600">
                      {t("home.services.newzealand.service3.price")}
                    </div>
                    <div className="text-sm text-muted-foreground">
                      {t("home.services.newzealand.service3.period")}
                    </div>
                  </div>
                </CardHeader>
              </Card>
                  ...
                  <CardHeader className="p-8">
                    ...
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 rounded-full bg-green-100 dark:bg-green-800 flex items-center justify-center">
                        <span className="text-green-600 dark:text-green-200 font-semibold">
                          MC
                        </span>
                      </div>
                      <div>
                        <div className="font-semibold">
                          {t("home.testimonials.brazil.testimonial1.name")}
                        </div>
                        <div className="text-sm text-muted-foreground">
                          {t("home.testimonials.brazil.testimonial1.location")}
                        </div>
                      </div>
                    </div>
                  </CardHeader>
                ...
                <Card className="bg-white dark:bg-gray-900 shadow-lg">
                  <CardHeader className="p-8">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-semibold">
                          {t("home.testimonials.brazil.testimonial2.name")}
                        </div>
                        <div className="text-sm text-muted-foreground">
                          {t("home.testimonials.brazil.testimonial2.location")}
                        </div>
                      </div>
                    </div>
                  </CardHeader>
                ...
                <Card className="bg-white dark:bg-gray-900 shadow-lg">
                  <CardHeader className="p-8">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-semibold">
                          {t("home.testimonials.brazil.testimonial3.name")}
                        </div>
                        <div className="text-sm text-muted-foreground">
                          {t("home.testimonials.brazil.testimonial3.location")}
                        </div>
                      </div>
                    </div>
                  </CardHeader>
                ...
                <Card className="bg-white dark:bg-gray-900 shadow-lg">
                  <CardHeader className="p-8">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-semibold">
                          {t("home.testimonials.newzealand.testimonial1.name")}
                        </div>
                        <div className="text-sm text-muted-foreground">
                          {t(
                            "home.testimonials.newzealand.testimonial1.location",
                          )}
                        </div>
                      </div>
                    </div>
                ...
                <Card className="bg-white dark:bg-gray-900 shadow-lg">
                  <CardHeader className="p-8">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-semibold">
                          {t("home.testimonials.newzealand.testimonial2.name")}
                        </div>
                        <div className="text-sm text-muted-foreground">
                          {t(
                            "home.testimonials.newzealand.testimonial2.location",
                          )}
                        </div>
                      </div>
                    </div>
                ...
                <Card className="bg-white dark:bg-gray-900 shadow-lg">
                  <CardHeader className="p-8">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-semibold">
                          {t("home.testimonials.newzealand.testimonial3.name")}
                        </div>
                        <div className="text-sm text-muted-foreground">
                          {t(
                            "home.testimonials.newzealand.testimonial3.location",
                          )}
                        </div>
                      </div>
                    </div>
            ...
            <div className="flex flex-col gap-4 min-[400px]:flex-row justify-center">
              ...
              <div className="flex flex-col gap-4 min-[400px]:flex-row justify-center">
                <Button
                  asChild
                  size="lg"
                  className="bg-white hover:bg-gray-100 text-green-600 dark:bg-black dark:hover:bg-gray-900 dark:text-white"
                >
