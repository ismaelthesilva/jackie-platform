  ...
  const questions = useMemo<Question[]>(
    () => [
      ...
      },
      {
        ...
        type: "email",
        title:
          "Please provide your email to receive your personalized nutrition plan",
        required: true,
      },
      ...
      },
      {
        id: "dieta_anterior",
        type: "yes_no",
        title: "Have you followed a diet before?",
        required: true,
      },
      {
        id: "tempo_seguiu_plano",
        type: "text",
        title: "How long were you able to follow the plan?",
