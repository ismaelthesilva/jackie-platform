...
export default function ProfessionalConsultationPage() {
  ...
  const questions = [
    ...
    },
    {
      ...
      subtitle:
        "We'll send your personalized diet plan here once Dr. Jackie completes it",
      type: "email" as const,
    ...
    },
    {
      ...
      subtitle:
        "Dr. Jackie will create a plan specifically designed for your objective",
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      if (error) {
        ...
        const consultationId = `CONSULT_${Date.now()}_${Math.random()
          .toString(36)
          .substr(2, 9)}`;
        console.log(
          "✅ Consultation request submitted successfully (fallback mode)"
        );
              ...
              <div className="space-y-3 text-left">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-700 text-sm">
                      Set up your secure account to access your personalized
                      diet plan
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-700 text-sm">
                      Dr. Jackie will personally analyze your goals and create
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-700 text-sm">
                      Get notified when your personalized diet plan is ready in
                      your dashboard
                    </p>
                  </div>
                </div>
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <Button
                  ...
                  size="lg"
                >
                  <LogIn className="mr-2 h-5 w-5" />I Have An Account
                </Button>
              </div>
        ...
        <Card className="shadow-xl border-0">
          <CardHeader className="text-center pb-4">
            <div className="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <div className="text-emerald-600">{currentQuestion.icon}</div>
            </div>
            ...
            currentQuestion.type === "email" ? (
              <div className="space-y-4">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange(
                      currentQuestion.id as keyof ConsultationFormData,
                      e.target.value
                    )
                  }
                ...
                {currentQuestion.options?.map((option) => (
                  ...
                  >
                    <div className="flex items-center justify-between w-full">
                      ...
                      {getCurrentFieldValue(currentQuestion.id) ===
                        option.value && (
            ...
            <div className="flex gap-3 pt-6">
              ...
              {currentStep < questions.length - 1 ? (
                <Button
                  ...
                  disabled={
                    !isCurrentStepValid() ||
                    (currentQuestion.type === "email" && !turnstileToken)
                  }
                  className={`${
                    currentStep === 0 ? "w-full" : "flex-1"
                  } bg-emerald-600 hover:bg-emerald-700 py-3`}
                >
                  Continue
                ...
                <Button
                  ...
                  disabled={
                    !isCurrentStepValid() || isSubmitting || !turnstileToken
                  }
                  className={`${
                    currentStep === 0 ? "w-full" : "flex-1"
                  } bg-emerald-600 hover:bg-emerald-700 py-3`}
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-700 text-xs">
                    Dr. Jackie will personally review your information and
                    create a customized nutrition plan tailored specifically for
                    your health goals.
                  </p>
                </div>
              </div>
