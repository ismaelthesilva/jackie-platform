...
const ProfessionalConsultationForm: React.FC = () => {
              ...
              <div className="space-y-3">
                {currentQuestion.options?.map((option) => (
                  <button
                    ...
                    className={`w-full p-4 text-left rounded-lg border-2 transition-all hover:bg-gray-50 ${
...
export default ProfessionalConsultationForm;
