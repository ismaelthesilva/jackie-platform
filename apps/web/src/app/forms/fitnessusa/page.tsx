...
export default function FitnessUSAPage() {
  ...
  const questions = useMemo<Question[]>(() => [
    ...
    { id: 'nome_completo', type: 'text', title: '1. Full name:', required: true },
    { id: 'data_nascimento', type: 'text', title: '2. Date of birth:', required: true },
    { id: 'altura', type: 'number', title: '3. Height (in cm):', required: true },
    { id: 'peso', type: 'number', title: '4. Current weight (in kg):', required: true },
    { id: 'percentual_gordura', type: 'text', title: '5. Body fat percentage (if known):', required: false },
    { id: 'localizacao', type: 'text', title: '6. Location (City and Country):', required: true },
    { id: 'profissao', type: 'textarea', title: '7. Occupation and work routine (shift work, sedentary, active job, etc.):', required: true },
    { id: 'horario_sono', type: 'text', title: '8. Usual sleep schedule (bedtime and wake time):', required: true },
    { 
      id: 'horas_sono', 
      type: 'multiple_choice', 
      title: '9. Average hours of sleep per night:',
    ...
    { 
      id: 'tipo_sono', 
      type: 'multiple_choice', 
      title: '10. How would you rate your sleep?',
      options: ['Light', 'Moderate', 'Deep'],
      required: true 
    },
    { id: 'acorda_descansado', type: 'yes_no', title: '11. Do you wake up feeling rested?', required: true },
    { id: 'energia_dia', type: 'textarea', title: '12. How would you describe your daily energy levels?', required: true },
    { id: 'fuma', type: 'yes_no', title: '13. Do you smoke?', required: true },
    { id: 'alcool', type: 'yes_no', title: '14. Do you consume alcohol?', required: true },
    { id: 'alcool_detalhes', type: 'textarea', title: 'Frequency and quantity:', condition: { id: 'alcool', value: 'Yes' }, required: true },
    { id: 'gestante', type: 'yes_no', title: '15. Are you pregnant or trying to conceive? (if applicable)', required: false },
    ...
    { id: 'doencas', type: 'textarea', title: '16. Do you have any diagnosed medical conditions? (e.g. hypothyroidism, PCOS, insulin resistance)', required: false },
    { id: 'lesoes', type: 'textarea', title: '17. Have you ever suffered any injuries? Please specify location and year:', required: false },
    { id: 'cirurgias', type: 'textarea', title: '18. Have you had any surgeries? Which ones and when?', required: false },
    { id: 'medicacao', type: 'textarea', title: '19. Do you take any medications regularly? Which ones?', required: false },
    { id: 'alergias', type: 'textarea', title: '20. Do you have any food allergies or intolerances?', required: false },
    { id: 'anticoncepcional', type: 'textarea', title: '21. Do you use birth control? Specify type and method:', required: false },
    { id: 'exames_sangue', type: 'yes_no', title: '22. Have you had blood work done in the last 6 months?', required: true },
    { id: 'exames_alteracoes', type: 'textarea', title: 'If yes, were there any abnormalities?', condition: { id: 'exames_sangue', value: 'Yes' }, required: true },
    ...
    { id: 'tempo_treino', type: 'text', title: '23. How long have you been training consistently?', required: true },
    { id: 'fases_cutting_bulking', type: 'textarea', title: '24. Have you ever done cutting or bulking phases? How many times?', required: false },
    { id: 'acompanhamento', type: 'textarea', title: '25. Have you ever worked with a professional coach or sports nutritionist?', required: false },
    { 
      id: 'tipo_treino', 
      type: 'multiple_select', 
      title: '26. What type of training are you currently doing?',
      options: ['Traditional strength training', 'Functional training', 'CrossFit', 'Free-form cardio', 'Other'],
      required: true 
    },
    { id: 'tipo_treino_outros', type: 'text', title: 'If other, please specify:', condition: { id: 'tipo_treino', value: 'Other' }, required: true },
    { id: 'dias_treino', type: 'text', title: '27. How many days per week can you realistically commit to training?', required: true },
    { id: 'tempo_treino_dia', type: 'text', title: '28. How much time do you have per session?', required: true },
    { 
      id: 'local_treino', 
      type: 'multiple_choice', 
    ...
    { id: 'restricao_equipamento', type: 'textarea', title: '30. Do you have any equipment limitations?', required: false },
    ...
    { 
      ...
      options: ['Fat loss', 'Muscle gain', 'Body recomposition', 'Performance improvement', 'Stage preparation (bodybuilding)'],
      required: true 
    },
    { id: 'objetivo_secundario', type: 'textarea', title: '32. What is your secondary goal?', required: false },
    { id: 'competir', type: 'textarea', title: '33. Are you planning to compete? If yes, in which category and federation?', required: false },
    { id: 'prazo_objetivo', type: 'text', title: '34. What is your deadline to achieve this goal?', required: true },
    { id: 'dieta_restrita', type: 'yes_no', title: '35. Are you willing to follow a strict diet if necessary?', required: true },
    { id: 'protocolos_avancados', type: 'yes_no', title: '36. Are you open to advanced strategies (depletion, carb-loading, strategic fasting, etc.)?', required: true },
    { id: 'enfase_corpo', type: 'textarea', title: '37. Which muscle group(s) do you want to emphasize?', required: false },
    { id: 'dificuldade_desenvolver', type: 'textarea', title: '38. Which muscle group(s) do you have the hardest time activating or developing?', required: false },
    { id: 'anabolizantes', type: 'textarea', title: '39. Have you ever used anabolic substances or performance enhancers? Which ones and when?', required: false },
    { id: 'estrategia_farmacologica', type: 'yes_no', title: '40. Are you planning to use any pharmacological strategy under professional guidance?', required: false },
    ...
    { id: 'exercicios_gosta', type: 'textarea', title: '41. Which exercises do you enjoy the most? Why?', required: true },
    { id: 'exercicios_detesta', type: 'textarea', title: '42. Which exercises do you dislike or avoid? Why?', required: true },
    { id: 'exercicios_lesao', type: 'textarea', title: '43. Are there any exercises you cannot perform due to injury or discomfort?', required: false },
    { 
      id: 'facilidade_treino', 
      type: 'multiple_choice', 
      title: '44. What training style suits you best:',
      options: ['Heavy loads', 'High volume (more reps)', 'Advanced techniques (drop-sets, rest-pause, etc.)'],
      required: true 
    },
    { id: 'dificuldade_grupo', type: 'textarea', title: '45. Do you struggle to activate any specific muscle group? Which one(s)?', required: false },
    { id: 'grupo_responde_facil', type: 'textarea', title: '46. Which muscle groups respond the fastest for you?', required: true },
    { id: 'dores_articulares', type: 'textarea', title: '47. Do you experience joint pain? Where and how often?', required: false },
    { 
      id: 'reacao_treino', 
      type: 'multiple_choice', 
      title: '48. How do you typically feel after a training session?',
      options: ['Energized', 'Exhausted', 'Sleepy', 'Irritable or extremely hungry'],
      required: true 
    },
    { id: 'dificuldade_ficha', type: 'yes_no', title: '49. Do you find it difficult to follow a workout plan on your own?', required: true },
    { 
    ...
    { id: 'resistencia_aerobica', type: 'textarea', title: '51. How would you rate your cardiovascular endurance?', required: true },
    { id: 'hiit', type: 'textarea', title: '52. Have you tried HIIT before? Did you enjoy it or feel unwell?', required: true },
    { id: 'cardio_jejum', type: 'yes_no', title: '53. Are you open to fasted cardio, if strategically advised?', required: true },
    { id: 'limitacao_respiratoria', type: 'textarea', title: '54. Do you have any respiratory or cardiovascular limitations?', required: false },
    { id: 'mobilidade', type: 'textarea', title: '55. Can you comfortably perform mobility or stretching routines? Do you currently do any?', required: true },
    ...
    { id: 'dias_treino_facilidade', type: 'textarea', title: '56. Which days are easiest for you to train? Which are most difficult?', required: true },
    { id: 'desafio_constancia', type: 'textarea', title: '57. Whats your biggest challenge right now in staying consistent?', required: true },
    { id: 'apoio_familia', type: 'yes_no', title: '58. Do you have support from family or friends regarding your fitness goals?', required: true },
    { id: 'motivo_desistencia', type: 'textarea', title: '59. What tends to discourage or derail you from your fitness plans?', required: true },
    { 
      id: 'comprometimento', 
      type: 'multiple_choice', 
    ...
    { id: 'fotos_corporais', type: 'yes_no', title: '61. Are you open to sending progress photos for evaluation?', required: false },
    { id: 'fotos_anteriores', type: 'yes_no', title: '62. Do you already have before/after photos?', required: false },
    { 
      id: 'checkins', 
      type: 'multiple_choice', 
    ...
    { id: 'apps_registro', type: 'yes_no', title: '64. Do you like using apps to track workouts or meals?', required: true },
    ...
    { id: 'plano_alimentar', type: 'textarea', title: '65. Are you currently following a meal plan? Created by whom?', required: false },
    { id: 'suplementos', type: 'textarea', title: '66. What supplements do you currently use (brand and dose)?', required: false },
    { id: 'ajuste_dieta', type: 'yes_no', title: '67. Are you willing to adjust your diet based on your periodized training program?', required: true },
    { id: 'facilidade_cozinhar', type: 'yes_no', title: '68. Do you find it easy to prepare your own meals?', required: true },
    { 
    ...
    { id: 'consumo_agua', type: 'text', title: '70. How much water do you drink per day (in liters)?', required: true },
    { id: 'monitora_agua', type: 'yes_no', title: '71. Do you track your water intake?', required: true },
    { id: 'sede_dia', type: 'textarea', title: '72. Do you feel thirsty throughout the day or during workouts?', required: true },
    { id: 'eletrolitos', type: 'yes_no', title: '73. Do you add electrolytes or use hydration supplements?', required: false },
    ...
    { id: 'ativacao_muscular', type: 'textarea', title: '74. Do you feel the target muscle working in most exercises? If not, in which exercises do you struggle with activation?', required: true },
    { id: 'dor_muscular', type: 'textarea', title: '75. Do you usually experience post-workout muscle soreness? Which muscle groups respond the most?', required: true },
    { id: 'dor_articular', type: 'textarea', title: '76. Do you ever feel joint pain during training? If so, where and when?', required: false },
    ...
    },
    {
      id: 'email',
      type: 'email',
      title: 'Please provide your email to receive your personalized plan',
      required: true
    },
    {
      id: 'thankYou',
      ...
      <Card className="w-full max-w-4xl mx-auto mb-8">
        <CardContent className="p-6">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">Track your fitness assessment completion</p>
          </div>
          ...
          <CardContent className="text-center space-y-4">
            ...
            {emailSent && (
              <div className="flex items-center justify-center space-x-2 text-green-600">
                ...
                <span className="text-lg font-semibold">Successfully submitted! Check your email soon.</span>
              </div>
            )}
          </CardContent>
        </Card>
      ...
      <Card className="w-full max-w-2xl mx-auto" ref={formRef}>
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              ...
              <Button
                ...
                className={cn(
                  "h-16 text-lg font-semibold transition-all",
                  answers[currentQ.id] === 'No' && "bg-emerald-600 hover:bg-emerald-700"
                )}
        ...
        {currentQ.type === 'checkbox' && (
          <div className="space-y-6">
            <div className="space-y-3">
              {currentQ.options?.map((option) => {
                const isChecked = Array.isArray(answers[currentQ.id]) && (answers[currentQ.id] as string[]).includes(option);
                return (
                  <Button
                    key={option}
