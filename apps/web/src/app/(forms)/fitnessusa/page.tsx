  ...
  const questions = useMemo<Question[]>(
    () => [
      ...
      },
      {
        id: "data_nascimento",
        type: "text",
        title: "2. Date of birth:",
        required: true,
      },
      {
        id: "altura",
        type: "number",
        title: "3. Height (in cm):",
        required: true,
      },
      {
        id: "peso",
        type: "number",
        title: "4. Current weight (in kg):",
        required: true,
      },
      {
        id: "percentual_gordura",
        type: "text",
        title: "5. Body fat percentage (if known):",
        required: false,
      },
      {
        id: "localizacao",
        type: "text",
        title: "6. Location (City and Country):",
        required: true,
      },
      {
        id: "profissao",
        type: "textarea",
        title:
          "7. Occupation and work routine (shift work, sedentary, active job, etc.):",
        required: true,
      },
      {
        id: "horario_sono",
        type: "text",
        title: "8. Usual sleep schedule (bedtime and wake time):",
        required: true,
      },
      {
        id: "horas_sono",
      ...
      },
      {
        ...
        type: "yes_no",
        title: "11. Do you wake up feeling rested?",
        required: true,
      },
      {
        id: "energia_dia",
        type: "textarea",
        title: "12. How would you describe your daily energy levels?",
        required: true,
      },
      {
        id: "fuma",
        type: "yes_no",
        title: "13. Do you smoke?",
        required: true,
      },
      {
        id: "alcool",
        type: "yes_no",
        title: "14. Do you consume alcohol?",
        required: true,
      },
      {
        id: "alcool_detalhes",
